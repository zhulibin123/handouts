...
patches-own [district-name confirmed population ]
...
to setup
  ...
  gis:load-coordinate-system (word "data/...") ;Add projection file
  ; Load all of our datasets
  set sites gis:load-dataset "data/..." ;Add Ebola Treatment Centers shapefile
  set roads gis:load-dataset "..." ;Add Sierra Leone Roads shapefile
  set districts gis:load-dataset "..." ;Add Cases at Admin. Level 2 shapefile
  set SL gis:load-dataset "..." ;Add Sierra Leone Admin. Level 1 shapefile
...
to draw
  ...
  ;Color patches by the number of confirmed cases
...
to load-pop
  ...
  [let centroid gis:location-of gis:centroid-of ?
    ...
    [create-turtles 1
      [set xcor item 0 centroid
        ...
        set size 1
        set shape "person"
        set name gis:property-value ? "GLOBAL_A_1"
        set label name
  ...
  [let row csv:from-row file-read-line
    ...
    [let pop (district_pop / 10000)
      hatch pop [set name district_name
        set status "S"
        set size 2
